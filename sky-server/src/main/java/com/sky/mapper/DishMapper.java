...
public interface DishMapper {
     ...
     * @param dish
     */
    @Select("select id, name, category_id, price, image, description, status, create_time, update_time, create_user, update_user from dish  where category_id=#{categoryId} and status=#{status} order by create_time desc")
